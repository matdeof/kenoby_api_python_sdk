# swagger_client.ParseHistoriesApi

All URIs are relative to *https://api.kenoby.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getparse_historiess**](ParseHistoriesApi.md#getparse_historiess) | **GET** /parse-histories | List multiple parse-histories resources.


# **getparse_historiess**
> ParseHistoriesList getparse_historiess(authorization, x_tenant, x_version, page=page, page_size=page_size, order_by=order_by, select_0=select_0, select_1=select_1, filter_by_file_like=filter_by_file_like, filter_by_user=filter_by_user, filter_by_created_at_from=filter_by_created_at_from, filter_by_created_at_to=filter_by_created_at_to, count_0_filter_by_file_like=count_0_filter_by_file_like, count_1_filter_by_created_at_from=count_1_filter_by_created_at_from)

List multiple parse-histories resources.

This operation allows you to list and search for parse-histories resources provided query arguments.
...
api_instance = swagger_client.ParseHistoriesApi()
...
filter_by_file_like = '' # str | Filter the results. This is just a sample. You can use a better tool like postman to try other filters. Ex: filterBy[fieldA]=some value&filterBy[fieldB][fieldDfromC]=other value (optional) (default to )
...
count_0_filter_by_file_like = '' # str | Return the total records from a filterBy query. Ex.: count[0][filterBy][name][like]=Ricardo (optional) (default to )
...
try:
    # List multiple parse-histories resources.
    api_response = api_instance.getparse_historiess(authorization, x_tenant, x_version, page=page, page_size=page_size, order_by=order_by, select_0=select_0, select_1=select_1, filter_by_file_like=filter_by_file_like, filter_by_user=filter_by_user, filter_by_created_at_from=filter_by_created_at_from, filter_by_created_at_to=filter_by_created_at_to, count_0_filter_by_file_like=count_0_filter_by_file_like, count_1_filter_by_created_at_from=count_1_filter_by_created_at_from)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ParseHistoriesApi->getparse_historiess: %s\n" % e)
```
...
[**ParseHistoriesList**](ParseHistoriesList.md)
